...
vector_t make_vector(unsigned s) {
  unsigned i;
  vector_t v;
  ((s!=0) ? (void) (0) : __assert_fail ("s!=0", "matrix.c", 20, __PRETTY_FUNCTION__));
...
double v_get(vector_t v, unsigned i) {
  ((i<v.size) ? (void) (0) : __assert_fail ("i<v.size", "matrix.c", 27, __PRETTY_FUNCTION__));
  return v.values[i];
}

void v_set(vector_t v, unsigned i, double x) {
  ((i<v.size) ? (void) (0) : __assert_fail ("i<v.size", "matrix.c", 32, __PRETTY_FUNCTION__));
  v.values[i] = x;
}

void v_add(vector_t v, unsigned i, double x) {
  ((i<v.size) ? (void) (0) : __assert_fail ("i<v.size", "matrix.c", 37, __PRETTY_FUNCTION__));
  v.values[i] += x;
}
...
matrix_t make_matrix(unsigned r, unsigned c) {
  unsigned i,j;
  matrix_t m;
  ((r!=0 && c!=0) ? (void) (0) : __assert_fail ("r!=0 && c!=0", "matrix.c", 44, __PRETTY_FUNCTION__));
...
double m_get(matrix_t m, unsigned i, unsigned j) {
  ((i<m.row_size && j<m.col_size) ? (void) (0) : __assert_fail ("i<m.row_size && j<m.col_size", "matrix.c", 52, __PRETTY_FUNCTION__));
  return m.values[i*m.col_size+j];
}

void m_set(matrix_t m, unsigned i, unsigned j, double x) {
  ((i<m.row_size && j<m.col_size) ? (void) (0) : __assert_fail ("i<m.row_size && j<m.col_size", "matrix.c", 57, __PRETTY_FUNCTION__));
  m.values[i*m.col_size+j] = x;
}

void m_add(matrix_t m, unsigned i, unsigned j, double x) {
  ((i<m.row_size && j<m.col_size) ? (void) (0) : __assert_fail ("i<m.row_size && j<m.col_size", "matrix.c", 62, __PRETTY_FUNCTION__));
  m.values[i*m.col_size+j] += x;
}
...
double scalar_prod(vector_t v1, vector_t v2) {
  int i;
  double r=0;
  ((v1.size==v2.size) ? (void) (0) : __assert_fail ("v1.size==v2.size", "matrix.c", 75, __PRETTY_FUNCTION__));
  for(i=0; i<v1.size; i++)
...
vector_t apply(matrix_t m, vector_t v) {
  ...
  ((m.col_size == v.size) ? (void) (0) : __assert_fail ("m.col_size == v.size", "matrix.c", 85, __PRETTY_FUNCTION__));
